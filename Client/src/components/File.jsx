...
//     type: "FILE",
//     item: { id: file.id, name: file.name, currentType: file.type },
//     collect: (monitor) => ({
...
//       headers: { "Content-Type": "application/json" },
//       credentials: "include",
//       body: JSON.stringify({ status: newStatus, id: file.id, remark: null }),
//     })
//       .then((response) => {
//         if (!response.ok) {
//           return;
...
//       headers: { "Content-Type": "application/json" },
//       credentials: "include",
//       body: JSON.stringify({ remark: remark, id: file.id, status: null }),
//     })
//       .then((response) => {
//         if (!response.ok) {
//           return;
